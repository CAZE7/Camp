...
describe('VDE Standards - Zentrale Konstante', () => {
  describe('Kabelquerschnitte', () => {
    it('sollten die Standard-Normreihe enthalten', () => {
      expect(VDE_CROSS_SECTIONS).toEqual([1.5, 2.5, 4.0, 6.0, 10.0, 16.0, 25.0, 35.0, 50.0, 70.0, 95.0, 120.0]);
    });
  ...
  describe('Strombelastbarkeit', () => {
    ...
    it('1.5mm² darf max. 16A führen (Standardwert)', () => {
...
describe('VDE Berechnungsfunktionen', () => {
  describe('calculateMinCrossSection', () => {
    ...
    it('verwendet den übergebenen maxVoltageDropFraction Parameter', () => {
      // Bei 5% drop: A_min doppelt so groß wie bei 10% drop
  ...
  describe('roundUpToVDECrossSection', () => {
    ...
    it('gibt den größten Wert zurück, wenn die Anforderung > 120 mm² ist', () => {
      expect(roundUpToVDECrossSection(500)).toBe(120);
    });
  });
  ...
  describe('calculateVoltageDrop', () => {
    ...
    it('berechnet 1.4V für 10A, 5m, 2.5mm² (ziemlich genau an der Grenze)', () => {
  ...
  describe('calculateConduitFillPercent', () => {
    ...
    it('zeigt Überfüllung bei zu vielen Kabeln', () => {
      // 10x 25mm² Kabel in EN 20 sollte deutlich überfüllt sein
      const fill = calculateConduitFillPercent('EN 20', Array(10).fill(25));
      expect(fill).toBeGreaterThan(60);
    });
  });
  ...
  describe('recommendConduitType', () => {
    ...
    it('gibt null zurück wenn kein Rohr groß genug ist', () => {
      // 50 Kabel mit 50mm² = ~26500 mm² → kein Rohr fasst das
...
describe('VDE Validator', () => {
  ...
  function makeEdge(id: string, source: string, target: string, data: any = { length: 3, crossSection: 2.5 }): Edge<CableEdgeData> {
    return { id, source, target, data, type: 'cableEdge' };
  }

  describe('validateCableEdge', () => {
    it('gibt Fehler zurück wenn Edge keine Daten hat', () => {
    ...
    it('gibt Fehler zurück bei Querschnitt unter VDE-Mindestmaß', () => {
    ...
    it('gibt Warnung bei hohem Spannungsabfall', () => {
    ...
    it('gibt Fehler bei zu großer Sicherung', () => {
      // 1.5mm² kann max 16A. Sicherung 30A ist zu groß.
    ...
    it('gibt Warnung bei nicht-normiertem Querschnitt', () => {
      // 3.0 mm² ist kein Standardwert
  ...
  describe('validateInverterNode', () => {
    ...
    it('gibt Warnung bei Last nahe 80% Grenze', () => {
      const node = makeNode('i1', 'inverter', { continuousPower: 1000, concurrentDevices: ['c1'] });
      const consumer = makeNode('c1', 'consumer230v', { watts: 850 }); // 85% - über 80%
      const results = validateInverterNode(node, [node, consumer]);
  ...
  describe('validateSchematic', () => {
    ...
    it('findet Kabel-Validierungsfehler', () => {
      ...
      const edge = makeEdge('e1', 'b1', 'c1', { length: 3, crossSection: 0.5 }); // zu klein
