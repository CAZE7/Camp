...
| Symbol                                          | File                                        | Purpose                                         | Called By                                 | Tests                                                     |
| ----------------------------------------------- | ------------------------------------------- | ----------------------------------------------- | ----------------------------------------- | --------------------------------------------------------- |
| `routePlan`                                     | `components/edges/utils/routeAll.ts`        | **zentraler Produktionspass mit Validation**    | `cableRouteStore`, Skripte, Golden Master | `routeAll.test.ts`, `routeAllCollisionGuarantee.test.ts`  |
| `portFanOutLanes`                               | `components/edges/utils/routeAll.ts`        | Lane-Vergabe je (Bauteil, Seite)                | `routePlan`                               | `routeAll.test.ts`                                        |
| `resolveHandlePoint`                            | `components/edges/utils/routeAll.ts`        | Port-Punkt + Flussrichtung                      | dto.                                      | dto.                                                      |
| `findCablePath`                                 | `components/edges/utils/pathfinding.ts`     | Einzelroute: Katalog → A* → Fallback            | `routePlan`                               | `pathfinding.test.ts`, `routingCache.test.ts`             |
...
| `nudgeOrthogonalPaths`                          | `components/edges/utils/nudge.ts`           | Überlappungen paralleler Trassen lösen          | `routePlan`                               | `nudge.test.ts`                                           |
| `mergeCloseBends`                               | `lib/routing/geometry/polyline.ts`          | Treppen/Ministufen auflösen (I7)                | `routePlan`                               | `geometry.test.ts`                                        |
...
| `assignFanOut`                                  | `lib/routing/rules/portFanOut.ts`           | Lane-Vergabe am Port-Bündel                     | `routePlan`                               | `portFanOut.test.ts`                                      |
| `resolveHops` / `routingPriority`               | `lib/routing/rules/hopping.ts`              | wer hüpft, wo sitzt der Bogen                   | `routePlan`                               | `hopping.test.ts`                                         |
| `LaneRegistry`                                  | `lib/routing/rules/laneRegistry.ts`         | stabile Korridorpräferenz im Produktionspass    | `routePlan`                               | `laneRegistry.test.ts`, `routeAll.test.ts`                |
...
| `validateFinalRouting`                          | `lib/routing/finalValidation.ts`            | binäres Final-Gate                              | `routePlan`, `cableRouteStore`, CI        | `scripts/routing/finalValidation.test.ts`                 |
