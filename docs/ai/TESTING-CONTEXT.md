...
| -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Routing** (Pfad, Kollision, Lane, Hop, Kosten, Token)              | Unit im betroffenen Modul · Invarianten-Suite · `npm run routing:audit` · Golden Master · Regression (15 Szenarien) · **Regressionstest für den konkreten Fall** · visuell (`npm run e2e -- visual`) |
