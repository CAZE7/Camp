...
export default function CamperAusbauguide() {
  return (
    <div className="flex min-h-screen flex-col bg-paper text-ink">
      <SiteHeader />
      <div id="ausbau-page" className="relative flex-1 overflow-hidden bg-paper px-4 pt-12 pb-24 sm:px-6">
      ...
      <main id="main" className="relative z-20 mx-auto max-w-3xl lg:ml-56 xl:mx-auto">
        ...
        <div className="border border-rule bg-bone p-8 shadow-sm md:p-12">
          ...
          <h1 className={cn("mb-6 text-3xl font-semibold leading-tight text-ink md:text-5xl", outfit.className)}>
          ...
          <div className="warn-card warn-card-info mb-10">
            ...
            <p className="text-sm leading-relaxed">
              <strong>Storytelling-Navigation:</strong> Auf großen Bildschirmen zeichnet sich links der Weg deines Vans mit — je weiter du scrollst, desto mehr Strecke wird sichtbar. Auf Mobilgeräten und bei aktivierter Einstellung „Bewegungen reduzieren" wird die Animation abgeschaltet.
            </p>
          </div>

          <div className="space-y-6 text-base leading-relaxed text-ink-soft md:text-lg">
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-10 mb-4", outfit.className)}>Die Reise beginnt: Dein Traum vom Vanlife</h2>
            <p>
            ...
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>1. Gesamtstrategie und Bauphasen</h2>
            <p>
            ...
            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>1.1 Der perfekte Bauablauf (Chronologisch)</h3>
            ...
            <div className="warn-card warn-card-warning my-10 flex-col">
              <div className="flex items-start gap-3">
                ...
                <p className="text-base leading-relaxed text-warn-warning"><strong>Profi-Tipp:</strong> Mach dir einen digitalen &quot;Schattenriss&quot; deines Vans (z. B. in SketchUp oder Vanspace3D) und plane jeden Millimeter, besonders die Kabelwege und Leerrohre.</p>
              </div>
              <div className="mt-3 flex items-start gap-3">
                <span aria-hidden="true" className="mt-0.5 text-lg">⚠️</span>
                <p className="text-base leading-relaxed text-warn-warning"><strong>Häufiger Anfängerfehler:</strong> Kabel lose in der Dämmung verlegen. Später willst du einen Schrank anschrauben, triffst ein unsichtbares Kabel und darfst die halbe Wand wieder aufreißen. Nutze immer Wellrohre und befestige sie am Blech!</p>
              </div>
            </div>

            <hr className="border-rule my-12" />

            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>2. Planung, Basis & Vorbereitung</h2>
            
            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>2.1 Das richtige Fahrzeug finden</h3>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-3 mt-6 mb-8 text-ink-soft">
            ...
            <div className="warn-card warn-card-critical my-8">
              <span aria-hidden="true" className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-warn-critical text-paper text-xs font-bold">!</span>
              <p className="text-base leading-relaxed text-warn-critical">
                <strong>Was passiert, wenn du die Stehhöhe falsch berechnest?</strong> Du musst jahrelang in deinem rollenden Zuhause den Kopf einziehen. Plane immer mit mindestens 5–7 cm Verlust durch Dämmung, Boden und Decke.
              </p>
            </div>

            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-10 mb-4", outfit.className)}>2.2 Material- & Werkzeug-Checkliste</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8 mb-12">
              <div className="border border-rule bg-paper p-6">
                <h4 className={cn("mb-4 text-lg font-semibold text-oxide", outfit.className)}>Must-Have Werkzeuge</h4>
                <ul className="space-y-3 text-base text-ink-soft">
                  <li className="flex gap-3"><span aria-hidden="true" className="text-oxide">✓</span><span><strong>Blechknabber / Nibbler:</strong> Für saubere Fensterausschnitte ohne Blechverzug.</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-oxide">✓</span><span><strong>Crimpzange (hydraulisch, 16–50 mm²):</strong> Unerlässlich für dicke Batteriekabel.</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-oxide">✓</span><span><strong>Crimpzange (0,5–6 mm²):</strong> Für Flachsteckerhülsen (niemals löten!).</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-oxide">✓</span><span><strong>Nietmutternzange (M4–M8):</strong> Gewinde sicher im Blech verankern.</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-oxide">✓</span><span><strong>Multimeter:</strong> Für Elektrik-Checks und Fehlersuche.</span></li>
                </ul>
              </div>
              <div className="border border-rule bg-paper p-6">
                <h4 className={cn("mb-4 text-lg font-semibold text-copper-deep", outfit.className)}>Wichtige Materialien</h4>
                <ul className="space-y-3 text-base text-ink-soft">
                  <li className="flex gap-3"><span aria-hidden="true" className="text-copper">◆</span><span><strong>Holz:</strong> Siebdruckplatte (12–15 mm) Boden, Pappelsperrholz (12–15 mm) Möbel.</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-copper">◆</span><span><strong>Kleber:</strong> SikaFlex 552 AT oder Dekasyl MS-5 (Konstruktion).</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-copper">◆</span><span><strong>Dichtmasse:</strong> Dekaseal 8936 (abtupfbare Masse für Fenster).</span></li>
                  <li className="flex gap-3"><span aria-hidden="true" className="text-copper">◆</span><span><strong>Rostschutz:</strong> Brantho-Korrux 3in1.</span></li>
                </ul>
              </div>
            </div>
            ...
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>3. Karosserie & Außenhülle</h2>
            ...
            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>3.1 Fenstereinbau & Dachluken</h3>
            <ul className="list-disc pl-6 space-y-3 mb-8 text-ink-soft">
            ...
            <div className="warn-card warn-card-warning my-8">
              ...
              <p className="text-base leading-relaxed text-warn-warning">
                <strong>Häufiger Anfängerfehler:</strong> Den Holz-Hilfsrahmen vergessen. Das Blech ist nur ~1 mm dick, Fensterklemmen brauchen aber oft 26–34 mm. Klebe einen passenden Holzrahmen von innen gegen das Blech, bevor du das Fenster verschraubst.
              </p>
            </div>

            <hr className="border-rule my-12" />

            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>4. Isolierung & Dämmung</h2>
            ...
            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>4.1 Materialkunde & Stärken</h3>
            <ul className="list-disc pl-6 space-y-3 mb-8 text-ink-soft">
            ...
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>5. Elektrik – Das Nervenzentrum</h2>

            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>5.1 Normen & Sicherheit (DIN VDE 0100-721)</h3>
            ...
            <h3 className={cn("text-xl md:text-2xl font-semibold text-ink mt-8 mb-4", outfit.className)}>5.2 Kabelquerschnitte berechnen</h3>
            ...
            <div className="warn-card warn-card-warning my-10">
              <span aria-hidden="true" className="mt-0.5 text-lg">💡</span>
              <p className="text-base leading-relaxed text-warn-warning"><strong>Profi-Tipp:</strong> Setze Sicherungen so nah wie möglich an die Batterie. Die Sicherung schützt das KABEL vor dem Durchschmoren, nicht das Endgerät!</p>
            </div>

            <hr className="border-rule my-12" />

            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>6. Klima & Heizung</h2>
            ...
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>7. Innenausbau (Boden, Wände, Möbel)</h2>
            ...
            <h2 className={cn("text-2xl md:text-3xl font-semibold text-ink mt-12 mb-4", outfit.className)}>8. Zulassung & Sicherheit</h2>
            ...
            <div className="warn-card warn-card-critical my-8">
              ...
              <p className="text-base font-semibold leading-relaxed text-warn-critical">
                Achtung: Ein 3,5-Tonner darf max. 3.500 kg wiegen (inkl. Passagiere). Fahre VOR dem endgültigen Möbelbau auf eine Waage!
              </p>
            </div>
            ...
            <div className="mt-24 border border-rule bg-soot p-10 text-center text-paper shadow-lg md:p-14">
              <h3 className={cn("mb-4 text-2xl font-semibold text-paper md:text-3xl", outfit.className)}>Bereit für den ersten Roadtrip?</h3>
              <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-paper/80 md:text-lg">
                Der Ausbau kostet Schweiß, zerschnittene Finger und Nerven. Aber der Moment, in dem du abends am Bergsee die Hecktüren öffnest und das Rauschen der Wellen hörst, ist unbezahlbar.
              </p>
              <Link
                href="/guides/ausbau-fahrplan"
