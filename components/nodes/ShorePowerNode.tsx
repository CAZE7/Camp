...
export default function ShorePowerNode({ id, data, isConnectable, selected }: any) {
  return (
    <div className={"bg-white border-2 border-indigo-500 rounded-md p-3 shadow-md w-48" + (selected ? " ring-4 ring-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.6)]" : "")}>
