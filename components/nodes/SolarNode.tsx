...
const SolarNode = function ({ id, data, isConnectable, selected }: PlannerNodeProps<PlannerNodeData>) {
  ...
  return (
    <div
      ...
      className={`hover:scale-105 transition-all custom-drag-handle bg-white border-2 border-orange-700 rounded-md p-3 shadow-md w-48 ${selected ? ' ring-4 ring-blue-500 shadow-xl' : ''}`}
    >
