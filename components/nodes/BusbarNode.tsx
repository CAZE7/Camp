...
const BusbarNode = function ({ id, data, isConnectable, selected }: PlannerNodeProps<BusbarNodeData>) {
  ...
  return (
    <div
      ...
      className={`custom-drag-handle w-48 rounded-md border-2 border-slate-700 bg-white p-3 shadow-md transition-all hover:scale-105 ${selected ? 'shadow-xl ring-4 ring-[var(--accent-line)]' : ''}`}
    >
