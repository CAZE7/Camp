...
export function FlowCanvas() {
  ...
  return (
    <>
      ...
      {showBOM && bomData && (
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 pointer-events-auto">
          <div className="bg-white p-6 rounded-lg shadow-xl w-96 max-h-[80vh] overflow-y-auto">
            ...
            <button
              ...
              className="mt-4 w-full bg-blue-500 text-white font-semibold py-2 rounded-lg hover:bg-blue-600 transition-colors"
            >
              Schließen
            </button>
          </div>
