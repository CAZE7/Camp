...
export function FlowCanvas() {
  ...
  const handleNodeDragStop = React.useCallback(
    (_event: React.MouseEvent, node: Node) => {
      ...
      setCollidingNodeId(null);
      // Routing V2: nach dem Drag die Kanten-Geometrie neu berechnen
      // (Wasser-Modus hat keine Kabel-Routen).
      if (viewMode !== 'water') rerouteV2();
    },
    [viewMode, showConnectionFeedback, rerouteV2]
  );
