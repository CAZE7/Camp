...
export const TEMPLATE_ALLROUNDER = {
  nodes: [
    ...
    { id: 'charger-1', type: 'charger', position: { x: 300, y: 100 }, data: { label: 'MPPT Ladebooster', amps: 30 } },
  ...
  edges: [
    ...
    { id: 'e-busbar-inv', source: 'busbar-plus', sourceHandle: 'out2', target: 'inverter-1', targetHandle: 'in', type: 'cableEdge', data: { length: 1, crossSection: 25, fuseSize: 60 } },
...
export const TEMPLATE_AUTARK = {
  nodes: [
    ...
    { id: 'charger-1', type: 'charger', position: { x: 300, y: 100 }, data: { label: 'MPPT Solarregler', amps: 30 } },
    { id: 'shore-1', type: 'shorePower', position: { x: 100, y: 250 }, data: { label: 'Landstrom' } },
  ...
  edges: [
    ...
    { id: 'e-busbar-inv', source: 'busbar-plus', sourceHandle: 'out2', target: 'inverter-1', targetHandle: 'in', type: 'cableEdge', data: { length: 1, crossSection: 50, fuseSize: 200 } },
