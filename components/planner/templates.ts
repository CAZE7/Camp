...
export const TEMPLATE_MINIMALIST = {
  ...
  edges: [
    ...
    { id: 'e-fuse-cool', source: 'fusebox-1', sourceHandle: 'plus', target: 'cons-cool', targetHandle: 'plus', type: 'cableEdge', data: { length: 2, crossSection: 4 } },
...
export const TEMPLATE_ALLROUNDER = {
  ...
  edges: [
    ...
    { id: 'e-batt-minus', source: 'battery-1', sourceHandle: 'minus', target: 'busbar-minus', targetHandle: 'minus', type: 'cableEdge', data: { length: 0.5, crossSection: 35 } },
    ...
    { id: 'e-charger-busbar', source: 'charger-1', sourceHandle: 'out-plus', target: 'busbar-plus', targetHandle: 'plus', type: 'cableEdge', data: { length: 1, crossSection: 10, fuseSize: 40 } },
    ...
    { id: 'e-dcdc-busbar', source: 'charger-2', sourceHandle: 'out-plus', target: 'busbar-plus', targetHandle: 'plus', type: 'cableEdge', data: { length: 1, crossSection: 16, fuseSize: 50 } },
    ...
    { id: 'e-fuse-pump', source: 'fusebox-1', sourceHandle: 'plus', target: 'cons-pump', targetHandle: 'plus', type: 'cableEdge', data: { length: 4, crossSection: 2.5 } },
    { id: 'e-fuse-light', source: 'fusebox-1', sourceHandle: 'plus', target: 'cons-light', targetHandle: 'plus', type: 'cableEdge', data: { length: 5, crossSection: 1.5 } },
    { id: 'e-busbar-inv-plus', source: 'busbar-plus', sourceHandle: 'plus', target: 'inverter-1', targetHandle: 'in-plus', type: 'cableEdge', data: { length: 1, crossSection: 25, fuseSize: 60 } },
    { id: 'e-busbar-inv-minus', source: 'inverter-1', sourceHandle: 'out-minus', target: 'busbar-minus', targetHandle: 'minus', type: 'cableEdge', data: { length: 1, crossSection: 25 } },
...
export const TEMPLATE_AUTARK = {
  ...
  edges: [
    ...
    { id: 'e-busbar-inv-plus', source: 'busbar-plus', sourceHandle: 'plus', target: 'inverter-1', targetHandle: 'in-plus', type: 'cableEdge', data: { length: 1, crossSection: 50, fuseSize: 200 } },
    { id: 'e-busbar-inv-minus', source: 'inverter-1', sourceHandle: 'out-minus', target: 'busbar-minus', targetHandle: 'minus', type: 'cableEdge', data: { length: 1, crossSection: 50 } },
