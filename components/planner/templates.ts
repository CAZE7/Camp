...
export const TEMPLATE_ALLROUNDER = {
  ...
  edges: [
    ...
    { id: 'e-solar-charger', source: 'solar-1', sourceHandle: 'plus', target: 'charger-1', targetHandle: 'plus', type: 'cableEdge', data: { length: 3, crossSection: 6 } },
    ...
    { id: 'e-busbar-inv-plus', source: 'busbar-plus', sourceHandle: 'plus', target: 'inverter-1', targetHandle: 'plus', type: 'cableEdge', data: { length: 1, crossSection: 25, fuseSize: 60 } },
    { id: 'e-busbar-inv-minus', source: 'busbar-minus', sourceHandle: 'minus', target: 'inverter-1', targetHandle: 'minus', type: 'cableEdge', data: { length: 1, crossSection: 25 } },
    { id: 'e-inv-230', source: 'inverter-1', sourceHandle: 'plus', target: 'cons-230v', targetHandle: 'plus', type: 'cableEdge', data: { length: 2, crossSection: 2.5, edgeDomain: 'AC_230V' } },
  ] as Edge<CableEdgeData>[],
};
