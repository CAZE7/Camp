 ...
 *
 *  - Backbone (Batterie ↔ Sicherung ↔ Verteilung): 3 px
 *  - normale Leitung: 2 px
 *  - Hover/Auswahl: +1 px (Hit-Feedback, ersetzt reine Hover-Farbe)
 *  - Trassen-Modus: Abgänge dünner (1,5 px), Hauptstränge bleiben 3 px
 */
export const BACKBONE_STROKE_WIDTH = 3;
