...
export default function Inspector({
  ...
  return (
    <div className="w-[250px] bg-toolbar border-l border-border p-4 flex flex-col h-full shadow-sm">
      ...
      {!hasSelection ? (
        ...
        <div className="flex flex-col space-y-4 flex-1">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="border border-border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accentp focus:border-transparent transition-shadow"
                />
              </div>
          ...
          {selectedNode && (
            <div className="flex flex-col space-y-4">
              <h3 className="font-semibold text-foreground text-sm">{selectedNode.data?.label || 'Komponente'}</h3>

              {selectedNode.type === 'battery' && (
                <>
                  <div className="flex flex-col">
                  {(chargingTimeStr || calculatedSolarWatts !== undefined) && (
                    <div className="mb-4 p-3 bg-acc-battery/10 border border-acc-battery/30 rounded-lg">
                      <h4 className="text-xs font-bold text-foreground mb-2 uppercase tracking-wider">Lade-Informationen</h4>
                    ...
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Kapazität (Ah)</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Zellchemie</label>
                    <select
              ...
              {selectedNode.type === 'consumer' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Leistung (W)</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Nutzung (h/Tag)</label>
                    <input
                      type="number"
                      min="0"
                      max="24"
              ...
              {selectedNode.type === 'charger' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Ladeleistung (A)</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Effizienz in %</label>
                    <input
                      type="number"
                      min="0"
                      max="100"
              ...
              {selectedNode.type === 'fuse' && (
                <div className="flex flex-col">
                  <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Sicherung (A)</label>
                  <input
                    type="number"
                    min="0"
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2 text-sm text-foreground">
                    <input
                      ...
                      className="rounded border-border text-accentp focus:ring-accentp"
                    />
                    RCD (FI-Schalter) {VDE_RCD_MAX_TRIP_CURRENT_MA}mA installiert
                  </label>
                  {!selectedNode.data?.hasRcd && (
                    <div className="p-2 bg-acc-fuse/10 text-foreground text-xs rounded border border-acc-fuse/30">
              ...
              {selectedNode.type === 'inverter' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Dauerleistung (W)</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div className="flex flex-col mt-4">
                    ...
                    <div className="flex flex-col gap-1 max-h-32 overflow-y-auto border border-border rounded p-1">
                      {nodes?.filter(n => n.type === 'consumer230v').map(consumer => {
                        const isChecked = (selectedNode.data?.concurrentDevices || []).includes(consumer.id);
                        return (
                          <label key={consumer.id} className="flex items-center gap-2 text-sm text-foreground cursor-pointer p-1 hover:bg-node-muted rounded">
                            <input
                              type="checkbox"
                              checked={isChecked}
                              onChange={(e) => {
              ...
              {selectedNode.type === 'consumer230v' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Leistung 230V (W)</label>
                    <input
                      type="number"
                      min="0"
                      value={selectedNode.data?.watts || 0}
              ...
              {selectedNode.type === 'solar' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Arbeitsspannung (V)</label>
                    <input
                      type="number"
                      min="0"
                      step="0.1"
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Strom (A)</label>
                    <input
                      type="number"
                      min="0"
                      step="0.1"
              ...
              {selectedNode.type === 'roofWindow' && (
                <>
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Breite (cm)</label>
                    <input
                      type="number"
                      min="1"
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Länge (cm)</label>
                    <input
                      type="number"
                      min="1"
              ...
              {selectedNode.type === 'roofSolar' && (
                <>
                  ...
                  <div className="flex flex-col">
                    <label className="text-xs font-medium text-muted-foreground mb-1 uppercase tracking-wider">Leistung (Wp)</label>
                    <input
                      type="number"
                      min="0"
                      value={selectedNode.data?.watts || 0}
                ...
                <>
                  <div className="flex flex-col">
                    ...
                    <select
                      ...
                      className="border border-border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accentp focus:border-transparent transition-shadow bg-toolbar"
                    >
                  ...
                  <div className="flex flex-col mt-4">
                    ...
                    {edges && edges.length > 0 ? (
                      <div className="flex flex-col gap-2 max-h-48 overflow-y-auto p-2 border border-border rounded">
                        {(() => {
                          ...
                          return edges.map(edge => {
                            ...
                            return (
                            <label key={edge.id} className="flex items-center gap-2 text-sm text-foreground cursor-pointer p-1 hover:bg-node-muted rounded">
                              <input
                                type="checkbox"
                      ...
                      <div className="text-xs text-muted-foreground italic p-2 bg-node-muted rounded border border-border">
          ...
          <div className="mt-auto pt-4">
            <button
              ...
              className="w-full bg-acc-fuse hover:bg-acc-fuse/90 text-white font-semibold py-2 px-4 rounded shadow transition-colors"
            >
              Löschen
            </button>
          </div>
